        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DigestTime = table.Column<string>(type: "text", nullable: false, defaultValue: "09:00"),
                    GithubWebhookSecret = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "feature"),
                    Assignee = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Column = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Backlog"),
                    Position = table.Column<int>(type: "integer", nullable: false),
                    GithubPrUrl = table.Column<string>(type: "text", nullable: true),
